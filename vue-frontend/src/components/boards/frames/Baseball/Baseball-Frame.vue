                  ...
                  <div class="league-scores">
                    <table>
                      <tr v-for="i in 7" :key="i">
                        <td class="league-scores-outer-td">
                          <tr>
                            <td>PHI</td>
                          </tr>
                          <tr>
...
.content-header{
  ...
  background-color:rgb(121, 116, 192);
  font-weight:bold;
  color:black;
  font-size:1vw;
  padding:5px;
...
.fcontainer{
  border-bottom:solid 10px rgb(185, 185, 185);
  height:10%;
  color:black;
  align-items: left;
}
